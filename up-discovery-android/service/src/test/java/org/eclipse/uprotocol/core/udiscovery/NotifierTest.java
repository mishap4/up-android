...
//        mUltifiLink = mock(UltifiLink.class);
        mNotifier = new Notifier(mObserverManager, mUltifiLink);
    ...
    private List<UUri> getUriPath() {
        ...
        UEntity serviceEntity = UEntity.newBuilder().setName(TEST_ENTITY).build();
        UEntity versionEntity = UEntity.newBuilder().setName(TEST_ENTITY).setVersionMajor(1).build();
