...
import static org.eclipse.uprotocol.ULink.PERMISSION_ACCESS_UBUS;
...
public class TestBase {
    ...
    protected static final UPayload PAYLOAD = buildPayload(DATA);
    ...
    protected static @NonNull UPayload buildPayload(@NonNull Message message) {
        return UPayload.newBuilder()
                .setFormatValue(UPayloadFormat.UPAYLOAD_FORMAT_PROTOBUF_VALUE)
